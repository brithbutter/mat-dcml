...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mat', choices=["mat","momat","dmomat", "mat_dec", "mat_encoder", "mat_decoder", "mat_gru","happo","rmappo","random","hatrpo","ppo","ippo"])
    ...
    parser.add_argument("--n_objective", type=int, default=1,
                        help="Number of objectives to be optimized")
    ...
    parser.add_argument("--use_advantage_norm", action='store_true', default=False, help="by default False, use normalized values to calculate advantage.")
